    ...
    <div class="row">
        ...
        <div class="col-6 text-center p-4">
            ...
            <ul class="p-5 list-group list-group-flush">
                <li class="list-group-item list-group-item-warning">Вихід: {{$info->Output}} </li>
                <li class="list-group-item list-group-item-warning">Місткість акумулятора: {{$info->Energy}} mAh</li>
                <li class="list-group-item list-group-item-warning">Сила струму: {{$info->Power}} A</li>
            </ul>
