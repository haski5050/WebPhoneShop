    ...
    <div class="row">
        ...
        <div class="col-6 text-center p-4">
            ...
            <ul class="p-5 list-group list-group-flush">
                ...
                <li class="list-group-item list-group-item-warning">Кількість виходів: {{$info->OutputCount}}</li>
                <li class="list-group-item list-group-item-warning">Сила струму: {{$info->Power}} А</li>
            </ul>
