        ...
        @foreach($buyers as $b)
            <div class="card">
                <div class="card-header" id="headingOne">
                    <h2 class="mb-0">
                        <button class="btn" type="button" data-toggle="collapse" data-target="#collapseOne{{$b->BuyerID}}" aria-expanded="true" aria-controls="collapseOne">
                            {{ $b->PIB }}
                        </button>
                    </h2>
                </div>
                <div id="collapseOne{{$b->BuyerID}}" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body">
                        <table class="table">
                            <thead>
                                <tr>
